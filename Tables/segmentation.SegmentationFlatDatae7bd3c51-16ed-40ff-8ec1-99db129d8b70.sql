CREATE TABLE [segmentation].[SegmentationFlatDatae7bd3c51-16ed-40ff-8ec1-99db129d8b70]
(
...
[EventDayofWeek] [nvarchar] (30) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
[Price_Code] [nvarchar] (25) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[Price_Code_Description] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[Price_Code_Group] [nvarchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
[Purchase_Days_To_Events] [int] NULL,
[Sales_Code] [nvarchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[Sales_Code_Name] [nvarchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[Promo_Code] [nvarchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
[Item_Class] [nvarchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[Plan_Name] [nvarchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[Plan_Code] [nvarchar] (50) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[Ticket_Type_Code] [nvarchar] (25) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[Ticket_Type_Name] [nvarchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[Ticket_Type_Description] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[Plan_Type_Code] [nvarchar] (25) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[Plan_Type_Name] [nvarchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[Plan_Type_Description] [nvarchar] (255) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[Seat_Type_Code] [nvarchar] (25) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[Seat_Type_Name] [nvarchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
[Is_Plan] [bit] NULL,
[Is_Partial_Plan] [bit] NULL,
[Is_Single_Event] [bit] NULL,
[Is_Group] [bit] NULL,
[Is_Broker] [bit] NULL,
[Is_Renewal] [bit] NULL,
[Comp_Code] [int] NULL,
...
[Pc_Price] [decimal] (18, 6) NULL,
[Pc_Other_1] [decimal] (18, 6) NULL,
[Pc_Other_2] [decimal] (18, 6) NULL,
[Pc_Tax] [decimal] (18, 6) NULL,
[Pc_License_Fee] [decimal] (18, 6) NULL,
[Pc_Surcharge] [decimal] (18, 6) NULL,
[Block_Purchase_Price] [decimal] (18, 6) NULL,
[Paid_Status] [nvarchar] (25) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
[Is_Prev_Game] [int] NOT NULL,
[Is_Next_Game] [int] NOT NULL
)
GO
ALTER TABLE [segmentation].[SegmentationFlatDatae7bd3c51-16ed-40ff-8ec1-99db129d8b70] ADD CONSTRAINT [pk_SegmentationFlatDatae7bd3c51-16ed-40ff-8ec1-99db129d8b70] PRIMARY KEY NONCLUSTERED  ([id])
GO
CREATE CLUSTERED INDEX [cix_SegmentationFlatDatae7bd3c51-16ed-40ff-8ec1-99db129d8b70] ON [segmentation].[SegmentationFlatDatae7bd3c51-16ed-40ff-8ec1-99db129d8b70] ([_rn])
GO
