...
[CreatedOn] [datetime] NULL CONSTRAINT [DF__TaskBatch__Creat__45F365D3] DEFAULT ([etl].[ConvertToLocalTime](CONVERT([datetime2](0),getdate(),(0)))),
[CreatedBy] [nvarchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL CONSTRAINT [DF__TaskBatch__Creat__46E78A0C] DEFAULT (suser_sname())
)
GO
ALTER TABLE [audit].[TaskBatchLog] ADD CONSTRAINT [PK__TaskBatc__3214EC275EB2C620] PRIMARY KEY CLUSTERED  ([ID])
GO
