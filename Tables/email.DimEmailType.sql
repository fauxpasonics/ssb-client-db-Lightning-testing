...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__DimEmailT__Creat__387B05D2] DEFAULT (getdate()),
[CreatedBy] [varchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[UpdatedDate] [datetime] NULL CONSTRAINT [DF__DimEmailT__Updat__396F2A0B] DEFAULT (getdate()),
