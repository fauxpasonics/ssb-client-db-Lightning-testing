...
[ETL__CreatedDate] [datetime] NULL CONSTRAINT [DF__TicketTag__ETL____5D5784C6] DEFAULT (getdate()),
[ETL__UpdatedDate] [datetime] NULL CONSTRAINT [DF__TicketTag__ETL____5E4BA8FF] DEFAULT (getdate()),
